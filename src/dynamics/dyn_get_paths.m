function paths = dyn_get_paths(computerDriveName)
...
switch computerDriveName
    case 'ROSETTA'
            figurePath = 'E:/Projects/dynamics/docs/';
            bhvDataPath = 'E:/Projects/neuro-behavior/data/processed_behavior/';
            nrnDataPath = 'E:/Projects/neuro-behavior/data/raw_ephys/';
            saveDataPath = 'E:/Projects/dynamics/data/';
    case 'Z'
            figurePath = 'Z:/middlebrooks/Projects/dynamics/docs/';
            ...
            saveDataPath = 'Z:/middlebrooks/Projects/dynamics/data/';
    case 'home'
            figurePath = '/Users/paulmiddlebrooks/Projects/dynamics/docs/';
            ...
            saveDataPath = '/Users/paulmiddlebrooks/Projects/dynamics/data/';
end

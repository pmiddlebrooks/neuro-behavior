...
opts.minActTime = .149; % is at least minActTime long (in seconds): this is .099999 instead of .1 b/c matlab precision thinks .1 doesn't equal .1 (see rrm_behavior_selection)
